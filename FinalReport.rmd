...
We reject the null hypothesis because there is a difference in covid 19 vaccine effectiveness among different subgroups(males, females, Drugusers, and LGBTQ). Vaccine effectiveness varies between subgroups and each subgroup had a difference P value, thus different rate of effectiveness in all subgroups qfter receiving the vaccine.
